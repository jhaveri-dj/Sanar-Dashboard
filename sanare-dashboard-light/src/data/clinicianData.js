...
const alexSessionLog = [
  { date: '2026-06-24', duration: 50, romAchieved: 118, avgActivation: 75, painScore: 1.6 },
  { date: '2026-06-22', duration: 48, romAchieved: 117, avgActivation: 74, painScore: 1.7 },
  { date: '2026-06-20', duration: 52, romAchieved: 116, avgActivation: 74, painScore: 1.7 },
  { date: '2026-06-18', duration: 49, romAchieved: 115, avgActivation: 73, painScore: 1.8 },
  { date: '2026-06-16', duration: 51, romAchieved: 114, avgActivation: 72, painScore: 1.8 },
...
/** Post-surgery knee starts at full extension; flexion recovery trends down on this scale. */
export const ROM_EXTENSION = 180
export const ROM_FLEXION_GOAL_CHART = 30 // chart Y (= 150° flexion clinically)

export function flexionToChart(flexionDeg) {
  return ROM_EXTENSION - flexionDeg
}
...
/** Y-axis ticks from flexion goal (30) up to full extension (180), 15° steps. */
export function romYAxisTicks() {
  const ticks = []
  for (let v = ROM_FLEXION_GOAL_CHART; v <= ROM_EXTENSION; v += 15) ticks.push(v)
  return ticks
}
