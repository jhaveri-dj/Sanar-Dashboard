...
import { buildPhasePlans } from '../../data/rehabPlanUtils'
...
function buildInitialPhasePlans(rehabPhases) {
  return buildPhasePlans(rehabPhases)
}
...
export default function RehabPlanEditor({ patientId, recoveryPlansPath, breadcrumbLabel = 'Recovery Plans' }) {
    ...
    <>
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13 }}>
          <Link to={recoveryPlansPath} style={{ color: '#374151', textDecoration: 'none' }}>{breadcrumbLabel}</Link>
